...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrow_button = (ImageButton) findViewById(R.id.upward_button);
        function_layout = (FrameLayout) findViewById(R.id.function_layout);
    ...
    public void OnClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.filter_button:
               // touched();
            case R.id.upward_button:
                if (function_layout.getVisibility() == View.VISIBLE) {
                    arrow_button.setImageResource(R.drawable.camera_btn_mode_up);
                    function_layout.setVisibility(View.GONE);
                } else if (function_layout.getVisibility() == View.GONE) {
            ...
            case R.id.sticker_button:
                if(mGraphicOverlay.getVisibility()==View.VISIBLE)
                {
                    ...
                    mStickerButton.setImageResource(R.drawable.camera_face_detection_on_press);
                    mGraphicOverlay.setVisibility(View.GONE);

                }
                else if (mGraphicOverlay.getVisibility() == View.GONE)
                {

                    mStickerButton.setImageResource(R.drawable.camera_face_detection_on);
